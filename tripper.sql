...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2022 at 06:31 AM
...
INSERT INTO `location` (`id`, `name`, `state`) VALUES
...
CREATE TABLE `places` (
  ...
  `placeImage` varchar(255) NOT NULL,
  `uid` int(11) NOT NULL,
...
INSERT INTO `places` (`placeId`, `Title`, `Description`, `Category`, `VisitTime`, `Budget`, `Address`, `placeImage`, `uid`, `locationId`, `modifiedDate`) VALUES
(56, 'Gandhi Ghat', 'Gandhi Ghat is one of the most popular ghats on the banks of the river Ganges in the city of Patna in Bihar. It is popular as the ashes of Mahatma Gandhi were immersed here.', 'Town & Cities', 'January to December', '50', 'Gandhi Ghat, beside NIT', 'IMG2118026937.jpg', 22, 14, '2022-01-21 00:26:39'),
(57, 'Cellular Jail', 'It has been an important historical part of Port Blair. Notable freedom fighters such as Veer Savarkar, Yogendra Shukla, Batukeshwar Dutt, and Babarao Savarkar were some of the inmates here. Don’t miss the Light and Sound Show (Monday, Wednesday, and Friday) when you visit Cellular jail.', 'Island', '9 AM to 1PM and 2PM to 4PM', '100', 'Cellular Jail, Port Blair', 'IMG1029951251.jpg', 22, 334, '2022-01-21 22:47:50'),
(58, 'Samudrika Naval Marine Museum', 'This museum is a perfect blend of Historical and Modern Andaman. A Massive Blue Whale, in its Skeletal Form, of course, greets you as you enter the museum. There is also an Aquarium with fish of all shapes and sizes, from a Parrotfish to the rare and Venomous Species of Stonefish and Corals.', 'Town & Cities', '9AM to 6PM', '200', 'Samudrika Navel Marine Museum, Andaman', 'IMG1998945272.jpg', 22, 334, '2022-01-22 00:06:22'),
(59, 'Dinner Cruise', 'TSG Bella Bay hosts a beautiful and luxurious Dinner Cruise that departs every evening from the Junglighat Jetty. If you are looking for a fun evening with some Live Music and a DJ with your loved ones or a special someone, we recommend this to be one of the best things in Port Blair. A cool evening sea breeze greets you while you listen to the Nicobar Band play live music, right under the stars.', 'Beaches', 'January to December', '2999', 'Port Blair', 'IMG201693775.jpg', 22, 334, '2022-01-22 00:20:29');
...
INSERT INTO `reviews` (`ratingId`, `placeId`, `star5`, `star4`, `star3`, `star2`, `star1`) VALUES
(1, 57, 10, 3, 2, 6, 2),
(3, 59, 32, 12, 6, 42, 5),
(4, 56, 14, 43, 45, 7, 16);
...
INSERT INTO `users` (`uid`, `name`, `username`, `email`, `password`, `dateOfBirth`, `gender`, `phone`, `verify_token`, `createdDate`) VALUES
(22, 'Harsh Kumar', 'harshmgr', 'kumarharsh8549@gmail.com', 'Harsh@123', '9/1/1997', 'Male', '+917004899150', '', '2022-01-09 18:25:30'),
(24, 'Harsh Kumar', 'harshmgr1', 'hkr951@gmail.com', 'Harsh@123', '9/1/1997', 'Male', '+917004899151', '', '2022-01-09 18:33:03'),
(25, 'Harsh Kumar', 'harsh', 'kumarharsh859@gmail.com', 'Harsh@123', '9/1/1997', 'Male', '+917004899155', '', '2022-01-09 18:41:20'),
(26, 'Manish Kumar', 'manish123', 'mainsh@gmail.com', 'Manish@123', '10/1/2000', 'Male', '+917004899154', '', '2022-01-10 20:39:07');

-- --------------------------------------------------------

--
-- Table structure for table `user_place_review`
--

CREATE TABLE `user_place_review` (
...
--
-- Indexes for table `user_place_review`
--
ALTER TABLE `user_place_review`
  ADD PRIMARY KEY (`rid`),
  ADD KEY `uid` (`uid`),
...
--
ALTER TABLE `places`
  MODIFY `placeId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `places`
  ADD CONSTRAINT `places_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `users` (`uid`),
  ADD CONSTRAINT `places_ibfk_2` FOREIGN KEY (`locationId`) REFERENCES `location` (`id`);

--
-- Constraints for table `reviews`
--
ALTER TABLE `reviews`
  ADD CONSTRAINT `reviews_ibfk_1` FOREIGN KEY (`placeId`) REFERENCES `places` (`placeId`);

--
-- Constraints for table `user_place_review`
--
ALTER TABLE `user_place_review`
  ADD CONSTRAINT `user_place_review_ibfk_1` FOREIGN KEY (`ratingId`) REFERENCES `reviews` (`ratingId`),
  ADD CONSTRAINT `user_place_review_ibfk_2` FOREIGN KEY (`uid`) REFERENCES `users` (`uid`);
COMMIT;
